...
interface CheckoutCardConfigProps {
  dataMap: Partial<COMMON.MedicalInformation>;
  config: CheckoutCardConfig;
}
const CheckoutCard: React.FC<CheckoutCardConfigProps> = ({ dataMap, config }) => {
  const { hasFooter, type, color, content, reminder, footer } = config;
